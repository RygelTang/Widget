 ...
 * @version 1.1.0
 */
public class WheelSelector extends View implements IWheelSelector, Runnable {
    /**
     * 滚动状态标识值
     *
    ...
    private static final String TAG = WheelSelector.class.getSimpleName();
    ...
    public WheelSelector(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.WheelSelector);
        int idData = a.getResourceId(R.styleable.WheelSelector_wheel_data, 0);
        mData = Arrays.asList(getResources()
                .getStringArray(idData == 0 ? R.array.WheelArrayDefault : idData));
        mItemTextSize = a.getDimensionPixelSize(R.styleable.WheelSelector_wheel_item_text_size,
                getResources().getDimensionPixelSize(R.dimen.WheelItemTextSize));
        mVisibleItemCount = a.getInt(R.styleable.WheelSelector_wheel_visible_item_count, 7);
        mSelectedItemPosition = a.getInt(R.styleable.WheelSelector_wheel_selected_item_position, 0);
        hasSameWidth = a.getBoolean(R.styleable.WheelSelector_wheel_same_width, false);
        mTextMaxWidthPosition =
                a.getInt(R.styleable.WheelSelector_wheel_maximum_width_text_position, -1);
        mMaxWidthText = a.getString(R.styleable.WheelSelector_wheel_maximum_width_text);
        mSelectedItemTextColor = a.getColor
                (R.styleable.WheelSelector_wheel_selected_item_text_color, -1);
        mItemTextColor = a.getColor(R.styleable.WheelSelector_wheel_item_text_color, 0xFF888888);
        mItemSpace = a.getDimensionPixelSize(R.styleable.WheelSelector_wheel_item_space,
                getResources().getDimensionPixelSize(R.dimen.WheelItemSpace));
        isCyclic = a.getBoolean(R.styleable.WheelSelector_wheel_cyclic, false);
        hasIndicator = a.getBoolean(R.styleable.WheelSelector_wheel_indicator, false);
        mIndicatorColor = a.getColor(R.styleable.WheelSelector_wheel_indicator_color, 0xFFEE3333);
        mIndicatorSize = a.getDimensionPixelSize(R.styleable.WheelSelector_wheel_indicator_size,
                getResources().getDimensionPixelSize(R.dimen.WheelIndicatorSize));
        hasCurtain = a.getBoolean(R.styleable.WheelSelector_wheel_curtain, false);
        mCurtainColor = a.getColor(R.styleable.WheelSelector_wheel_curtain_color, 0x88FFFFFF);
        hasAtmospheric = a.getBoolean(R.styleable.WheelSelector_wheel_atmospheric, false);
        isCurved = a.getBoolean(R.styleable.WheelSelector_wheel_curved, false);
        mItemAlign = a.getInt(R.styleable.WheelSelector_wheel_item_align, ALIGN_CENTER);
        fontPath = a.getString(R.styleable.WheelSelector_wheel_font_path);
        a.recycle();
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                // 滚动内容
                // Scroll WheelSelector's content
            ...
            case MotionEvent.ACTION_UP:
                ...
                // 根据速度判断是该滚动还是滑动
                // Judges the WheelSelector is scroll or fling base on current velocity
    ...
    public void setSelectedItemPosition(int position, final boolean animated) {
        ...
        if (animated && mScroller.isFinished()) {
            // We go non-animated regardless of "animated" parameter if scroller is in motion
    ...
    public void setData(List data) {
        if (null == data) {
            throw new NullPointerException("WheelSelector's data can not be null!");
        }
        mData = data;
    ...
    public interface OnItemSelectedListener {
         ...
         */
        void onItemSelected(WheelSelector picker, Object data, int position);
    }
    ...
    public interface OnWheelChangeListener {
         ...
         * <p>
         * Invoke when WheelSelector scroll stopped
         * WheelSelector will return a distance offset which between current scroll position and
         * initial position, this offset is a positive or a negative, positive means WheelSelector is
         * scrolling from bottom to top, negative means WheelSelector is scrolling from top to bottom
         *
         ...
         * <p>
         * Invoke when WheelSelector scroll stopped
         * This method will be called when WheelSelector stop and return current selected item data's
         * position in list
         *
         ...
         * <p>
         * Invoke when WheelSelector's scroll state changed
         * The state of WheelSelector always between idle, dragging, and scrolling, this method will
         * be called when they switch
         *
         * @param state 滚轮选择器滚动状态，其值仅可能为下列之一
         *              {@link WheelSelector#SCROLL_STATE_IDLE}
         *              表示滚动选择器处于静止状态
         *              {@link WheelSelector#SCROLL_STATE_DRAGGING}
         *              表示滚动选择器处于拖动状态
         *              {@link WheelSelector#SCROLL_STATE_SCROLLING}
         *              表示滚动选择器处于滑动状态
         *              <p>
         *              State of WheelSelector, only one of the following
         *              {@link WheelSelector#SCROLL_STATE_IDLE}
         *              Express WheelSelector in state of idle
         *              {@link WheelSelector#SCROLL_STATE_DRAGGING}
         *              Express WheelSelector in state of dragging
         *              {@link WheelSelector#SCROLL_STATE_SCROLLING}
         *              Express WheelSelector in state of scrolling
         */
